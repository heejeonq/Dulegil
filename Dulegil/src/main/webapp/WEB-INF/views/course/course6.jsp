...
<body>
	...
	<div class="container-main">
		<div class="mainWrap">
			...
			<div class="crsCon">
				<div class="crsDtl">					
				<span id="crsInfo">안양천코스는 석수역에서 출발해 안양천, 한강을 따라 걸어 가양역에 도착하는 코스이다. 

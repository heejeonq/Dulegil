				...
				<div class="contents_wrap">		
					...
					<div class="join_info">
						...
						<div class="m_id">
							...
							<input type="text" name="m_id" value="goodee0205@naver.com" readonly="readonly" >
						</div>
						<div class="pw01">
							<label for="pw"></label>
							<input type="password" name="f_pwd" value="12345678">
						</div>
						<div class="pw02">
							<label for="pw"></label>
							<input type="password" name="f_pwd_re" placeholder="비밀번호 확인">
						</div>
						<div class="name01">
							<label for="name"></label>
							<input type="text" name="f_name" value="구디아카데미">
						</div>
						...
						<div class="birth01">
							...
							<input type="date" name="f_birthday" value="2022.05.09" onblur="return chk_num(this.name);">
						</div>
						<div class="gender01">
							<div class="g_box">
							<input type="radio" name="f_gender" value="M"><label for="M">남성</label>
						</div>
						<div class="g_box">
							<input type="radio" name="f_gender" value="F" checked=""><label for="F">여성</label>
						</div>
						</div>
						<div class="m_phone">
							<label for="phone"></label>
							<input type="text" name="f_phone1" value="01012345678" onblur="return chk_num(this.name);">
						</div>
						<div class="add_area">
							<div class="zip_code">
								<label for="zipcode"></label>
								<input type="text" name="f_zipcode" id="sample6_postcode">		
							</div>
							<input type="button" class="address_btn" onclick="sample6_execDaumPostcode()" value="주소검색">
							<div class="add_01">
								<label for="address"></label>
								<input type="text" name="f_addr1" id="sample6_address" >  
							</div>
						    <div class="add_02">
								<label for="address"></label>
								<input type="text" name="f_addr2" id="sample6_detailAddress"> 
							</div>
						</div>
					</div>
					<div class="popup_btn">
